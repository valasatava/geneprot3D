 ...
 */
public class ExonStructuralData extends ExonSerializable {
    ...
    public ExonStructuralData(String chromosome, String geneName, int start, int end, String orientation) {
