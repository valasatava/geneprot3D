...
public class ReadVcfData {
	...
	public static void main(String[] args) throws Exception {
		...
		VcfParser parser = new VcfParser.Builder().fromFile(file).parseWith((metadata, position, sampleData) -> {
			...
			// a site at which two alternate alleles (e.g. A -> G, T)
			// a site that is called monomorphic reference (i.e. with no
			// alternate alleles) (e.g. A -> .)
			// a microsatellite with two alternative alleles (GTC -> G, GTCT)
